...
public class GetStockHistory {
	@GET
	@Path("{stocksymbol}/{api_token}/{date_from}/{date_to}")
	@Produces(MediaType.APPLICATION_JSON)
	public Response getStockPrices(@PathParam("stocksymbol") String stocksymbol,
			@PathParam("api_token") String api_token, @PathParam("date_from") String date_from,
		...
		try {
			...
			HttpGet getReq = new HttpGet("/api/v1/history?symbol=" + stocksymbol + "&sort=newest&api_token=" + api_token
			...
			/*
			 * JSONObject stocks = new JSONObject(); stocks.put("name",
			 * "Apple"); stocks.put("closingPrices", closingPrices); JSONArray
			 * stockPrices = new JSONArray(); stockPrices.put(stocks);
			 * JSONObject historicalStockPrices = new JSONObject();
			 * historicalStockPrices.put("HistoricalPrices", stockPrices);
			 * JSONObject stockPriceHistory = new JSONObject();
			 * stockPriceHistory.put("stockQuotes", historicalStockPrices);
			 */
